    ...
    <div class="row rt ">
        ...
        <div class="col-sm-8 col-lg-10 col-md-9 col-xs-12">
            ...
            <div class="col-md-12 rr ">
                <div class="ps">
                    <h3 style="padding-left: 10px;padding-top: 10px;"> Add Product Size
                    <ul class="list-inline pull-right">
                            	<li><?php echo $this->Html->link('<i class="fa fa-list"></i> List Product Sizes',array('controller'=>'ProductSizes','action'=>'index', 'bandhead' => true),array('escape'=>false)); ?></li>
                            </ul>		
                    </h3>
                </div>
            </div>
            <div class="col-md-12">
                <div class="content-forms content-box">
                  ...
                  <div class="content-forms-field">
                        ...
                        <div class="input select required">
                            <?php echo $this->Form->input('type', array('type' => 'text', 'label' => false, 'class' => 'type_required', 'required' => false, 'placeholder' => 'Type'));?>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                      <div class="content-forms-field">
