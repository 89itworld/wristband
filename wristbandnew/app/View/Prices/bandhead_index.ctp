                        ...
                        <div class="col-md-12 rr" >
                            ...
                            <h3  style="padding-left: 10px;padding-top: 10px;"><i class="fa fa-money"></i> Manage Product Prices
                            	<ul class="list-inline pull-right">
                            		<li><?php echo $this->Html->link('<i class="fa fa-plus-circle"></i> Add Product Price',array('controller'=>'Prices','action'=>'add', 'bandhead' => true),array('escape'=>false)); ?></li>
                            	</ul>	
                            </h3></div>
                        </div>
                         <?php if(!empty($result)) {?>
                            ...
                            foreach ($result as $key => $data) {
                                ...
                                <td>
                                    <?php 
                                        ...
                                        echo $this->Html->link('<span class="glyphicon glyphicon-search" style="color: #2997D4;"> </span>',array('controller'=>'Prices','action'=>'view',base64_encode($data['Price']['id']),'bandhead'=>true),array('escape'=>false,'title'=>"View")).' ';
                                        echo $this->Html->link('<span class="glyphicon glyphicon-pencil" style="color: #FFCC00;"> </span>',array('controller'=>'Prices','action'=>'edit',base64_encode($data['Price']['id']),'bandhead'=>true),array('escape'=>false,'title'=>"edit"));
                                    ?>
                                </td>
                                </tr>
                           <?php $SrNos++; }?>
