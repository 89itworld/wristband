                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped">
                                ...
                                <tr>
                                    <td class="table-title">Quantity Price: <?php echo $record["Price"]["qty"]; ?></td>
                                    <td>  <?php
                                        echo  isset($record['Price']['price']) ? $record['Price']['price'] : '';
                                        ?></td>
                                     <td class="table-title">Quantity Free: <?php echo $record["Price"]["qty"]; ?></td>
                                    <td>  <?php
                                        echo  isset($record['Price']['free_qty']) ? $record['Price']['free_qty'] : '';
                                        ?></td>
                                </tr>
                                    <?php } ?>
                                </tbody>
