<script>
      function get_products(cat_id) {
        $.ajax({
            url: '<?php echo $this->Html->url(array('controller' => 'OtherPrices','action' => 'get_cat_product','bandhead'=>false)); ?>',
            type: "POST",
            data: {'cat_id': cat_id},
      ...
      function get_sizes(cat_id) {
        $.ajax({
            url: '<?php echo $this->Html->url(array('controller' => 'OtherPrices','action' => 'get_cat_sizes','bandhead'=>false)); ?>',
            type: "POST",
            data: {'cat_id': cat_id},
            success: function (resp) {
                $(size_id).html(resp);
      ...
      function get_styles(cat_id) {
        $.ajax({
            url: '<?php echo $this->Html->url(array('controller' => 'OtherPrices','action' => 'get_cat_styles','bandhead'=>false)); ?>',
            type: "POST",
            data: {'cat_id': cat_id},
            success: function (resp) {
                $(style_id).html(resp);
    ...
    function get_items(cat_id) {
        ...
        $.ajax({
            url: '<?php echo $this->Html->url(array('controller' => 'OtherPrices','action' => 'get_fill_items','bandhead'=>false)); ?>',
            type: "POST",
            data: {'cat_id': cat_id},
            success: function (resp) {
                $(fill).html(resp);
    ...
    <div class="row rt ">
        ...
        <div class="col-sm-8 col-lg-10 col-md-9 col-xs-12">
            ...
            <div class="col-md-12 rr ">
                <div class="ps">
                    <h3 style="padding-left: 10px;padding-top: 10px;"> Add Other Price
                    <ul class="list-inline pull-right">
                            		<li><?php echo $this->Html->link('<i class="fa fa-list"></i> List Other Price',array('controller'=>'OtherPrices','action'=>'index', 'bandhead' => true),array('escape'=>false)); ?></li>
                            	</ul>	
                    </h3>
                </div>
            </div>
            <div class="col-md-12">
                <div class="content-forms content-box">
                    <?php echo $this->Form->create('OtherPrice', array('id' => 'add_product_style', 'type' => 'file'));?>
