                ...
                <div class="col-sm-8 col-md-9 col-lg-10">
                    ...
                    <div class="row rr cm ">
                        <div class="col-md-12 rr" >
                            <div class="ps">
                        <h3 style="padding-left: 10px;padding-top: 10px;"><i class="fa fa-group"></i> Manage Users <ul class="list-inline pull-right">
                        <li><?php echo $this->Html->link('<i class="fa fa-plus-square"></i> Add User',array('controller'=>'Users','action'=>'addUser'), array('escape' =>false)); ?></li>
                        </ul></h3>
                    </div>
                        </div>
<?php echo $this->Form->create('User', array('url' => array('controller' => 'Users', 'action' => 'dashboard','admin'=>true))); ?>
                                    ...
                                    foreach ($User_data as $key => $data) {
                                        ...
                                        <td>
                                            <?php 
                                                ...
                                                echo $this->Html->link('<span class="'.$class.'" style="color: '.$color.' "> </span>',array('controller'=>'users','action'=>$action,base64_encode($data['User']['id']),'admin'=>true),array('escape'=>false)).' ';
                                                echo $this->Html->link('<span class="glyphicon glyphicon-search" style="color: #2997D4;"> </span>',array('controller'=>'users','action'=>'viewUser',base64_encode($data['User']['id']),'admin'=>true),array('escape'=>false)).' ';  
                                                echo $this->Html->link('<span class="glyphicon glyphicon-pencil" style="color: #FFCC00;"> </span>',array('controller'=>'users','action'=>'editUser',base64_encode($data['User']['id']),'admin'=>true),array('escape'=>false)); 
                                            ?>
                                        </td>
                                        </tr>
                                   <?php $SrNos++; }?>
