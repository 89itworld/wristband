                                ...
                                <tr class="<?php if($key%2==0){echo 'tt'; }?>">
                                    ...
                                    <td>
                                        <?php 
                                            ...
                                            echo $this->Html->link('<span class="glyphicon glyphicon-search" style="color: #2997D4;"> </span>',array('controller'=>'Orders','action'=>'view',base64_encode($data['Order']['id']),'bandhead'=>true),array('escape'=>false,'title'=>"View"));
                                        ?>
                                    </td>
                                </tr>
                           <?php $SrNos++; }?>
