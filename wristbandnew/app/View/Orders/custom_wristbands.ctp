                            ...
                            <div class="text-holder">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-4 col-sm-4">
                                        ...
                                        <input class="qty txtQty" refid="<?php echo $value['id']; ?>" metallic="2" placeholder="Qty" refname="<?php echo ucfirst($value['name']); ?>" reft="Toddler" ref="<?php echo str_replace("#", '', $value['hex_value']); ?>" reftype="<?php echo $value['product_style_id']; ?>" name="txtToddler" type="text">
                                    ...
                                    <div class="col-xs-4 col-sm-4">
                                        ...
                                        <input class="qty txtQty" refid="<?php echo $value['id']; ?>" metallic="2" placeholder="Qty" refname="<?php echo ucfirst($value['name']); ?>" reft="Youth" ref="<?php echo str_replace("#", '', $value['hex_value']); ?>" reftype="<?php echo $value['product_style_id']; ?>" name="txtYouth" type="text">
                                    ...
                                    <div class="col-xs-4 col-sm-4">
                                        ...
                                        <input class="qty txtQty" refid="<?php echo $value['id']; ?>" metallic="2" placeholder="Qty" refname="<?php echo ucfirst($value['name']); ?>" reft="Adult" ref="<?php echo str_replace("#", '', $value['hex_value']); ?>" reftype="<?php echo $value['product_style_id']; ?>" name="txtAdult" type="text">
    ...
    <tr>
        <td class="left">
            ...
            <p><label class="ieText"><span class="lblMsgStyle">Front</span> message</label>
                <span>
                    <!-- onkeyup="getIllust('fronttxtmsg')" -->
                    <input id="fronttxtmsg" maxlength="40" placeholder="Enter Front Message" type="text" >
        ...
        <td class="right">
            ...
            <p class="back_msg_con">
                ...
                <span>
                    <!-- onkeyup="getIllust('backtxtmsg')" -->
                    <input id="backtxtmsg" maxlength="40" placeholder="Enter Back Message" type="text" >
    ...
    <tr>
        ...
        <td>
            ...
            <a class="drpMenuItems closex" id="btnSelectFont" title="Change Font" href="javascript:void(0)">
                ...
                <img src="http://103.230.152.50/wristbandnew/orders/fontEffects?_route_=font&size=20&name=4897462015-03-27arialbd.ttf&effect=printed&color=222222&text=arial bold" />
                <span></span>
            </a>
...
*/
    ...
    */
    ...
    function getIllust(id){
       ...
       $.ajax({
            url: '<?php echo $this->Html->url(array('controller' => 'Orders','action' => 'createIllustration','bandhead'=>false)); ?>',
            type: "POST",
    ...
    var UPLOAD_URL = '<?php echo $this->Html->url(array('controller' => 'Orders','action' => 'clipUpload','bandhead'=>false)); ?>';
