    ...
    <div class="row rt ">
        ...
        <div class="col-sm-8 col-md-9 col-lg-10 col-xs-12">
            ...
            <div class="col-md-12 rr ">
                <div class="ps">
                    <h3 style="padding-left: 10px;padding-top: 10px;"> Edit Product Style</h3>
                </div>
            </div>
            <div class="col-md-12">
                <div class="content-forms content-box">
                    <?php echo $this->Form->create('ProductStyle', array('id' => 'add_product_size', 'type' => 'file'));?>
                    ...
                    <div class="content-forms-field">
                        ...
                        <div class="input select required">
                            <?php echo $this->Form->input('product_id', array('type' => 'select', 'options' => $product_list,"id"=>"product_id", 'default'=>$this->data['ProductStyle']['product_id'], 'label' => false, 'required' => false, 'class' => 'product_required'));?>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                    <div class="content-forms-field">
                  ...
                  <div class="content-forms-field">
                        ...
                        <div class="input select required">
                            <?php echo $this->Html->image('ProductStyleIcon/' . $this->request->data['ProductStyle']['image'], array('style' => 'width:50px;height:50px;')); ?>
                            <?php echo $this->Form->input('old_image', array('type' => 'hidden', 'div' => false, 'label' => false, 'value' => $this->request->data['ProductStyle']['image'])); ?>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                    <div class="content-forms-field">
                        ...
                        <div class="input select required">
                            <?php echo $this->Form->input('image', array('type' => 'file', 'id' => "file_upload", 'div' => false, 'required' => false, 'label' => false, 'class' => 'image_required', 'maxlength' => 100)); ?>
                               <p class="error-message"style="font-size: 12px;">(Max file size 1MB.)</p>
                               <div class="clearfix"></div>
