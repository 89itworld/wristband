<script>
    ...
    $(document).ready(function() {
        $("#GalleryBandheadEditForm").validate();
    });
            ...
            <div class="row rt ">
		        ...
		        <div class="col-sm-8 col-lg-10 col-md-9 col-xs-12">
		            ...
		            <div class="col-md-12 rr ">
		                <div class="ps">
		                    <h3 style="padding-left: 10px;padding-top: 10px;"> Edit Gallery Image</h3>
		                </div>
		            </div>
		            <div class="col-md-12">
                        ...
                        <div class="input select required">
	                            <?php echo $this->Html->image('gallery/small/' . $this->request->data['Gallery']['image'], array('style' => 'width:50px;height:50px;')); ?>
	                            <?php echo $this->Form->input('old_image', array('type' => 'hidden', 'div' => false, 'label' => false, 'value' => $this->request->data['Gallery']['image'])); ?>
	                        </div>
	                        <div class="clearfix"></div>
	                    </div>
	                    <div class="content-forms-field">
