    ...
    <div class="row rt ">
        ...
        <div class="col-sm-8 col-lg-10 col-md-9 col-xs-12">
            ...
            <div class="col-md-12 rr">
                <div class="ps">
                    <h3 style="padding-left: 10px;padding-top: 10px;"> Add Shipping Price
                    <ul class="list-inline pull-right">
                            	<li><?php echo $this->Html->link('<i class="fa fa-list"></i>
                            	 List Shipping Prices',array('controller'=>'ShippingPrices','action'=>'index', 'bandhead' => true),array('escape'=>false)); ?></li>
                            </ul>	
                    </h3>
                </div>
            </div>
            <div class="col-md-12">
                <div class="content-forms content-box">
                    <?php echo $this->Form->create('ShipTimePrice', array('id' => 'add_shipping_price', 'type' => 'file'));?>
