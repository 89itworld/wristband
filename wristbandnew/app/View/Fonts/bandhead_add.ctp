    ...
    <div class="row rt ">
        ...
        <div class="col-sm-8 col-lg-10 col-md-9 col-xs-12">
            ...
            <div class="col-md-12 rr ">
                <div class="ps">
                    <h3 style="padding-left: 10px;padding-top: 10px;"> Add Font Style
            ...
            <div class="col-md-12">
                <div class="content-forms content-box">
                    <?php echo $this->Form->create('Font', array('id' => 'font_style', 'type' => 'file'));?>
                    ...
                    <div class="content-forms-field">
                        <label>Font file<span class="require_field">*</span></label>
