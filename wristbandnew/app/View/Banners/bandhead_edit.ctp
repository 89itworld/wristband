<script>
	$(document).ready(function() {
		$("#BannerBandheadEditForm").validate();
	});
		...
		<div class="col-sm-8 col-lg-10 col-md-9 col-xs-12">
			<div class="row rr">
				<div class="col-md-12 rr ">
					<div class="ps">
						<h3 style="padding-left: 10px;padding-top: 10px;"> Edit Banner</h3>
					</div>
				</div>
				<div class="col-md-12">
					<div class="content-forms content-box">
						...
						<div class="content-forms-field">
							<label class="inner_label">Current Banner</label>

							<div class="input select required">
								<?php echo $this -> Html -> image('banners/' . $this -> request -> data['Banner']['image'], array('class' => 'img-responsive','style' => 'display:inline')); ?>
								<?php echo $this -> Form -> input('old_image', array('type' => 'hidden', 'div' => false, 'label' => false, 'value' => $this -> request -> data['Banner']['image'])); ?>
							</div>
							<div class="clearfix"></div>
						</div>
						<div class="content-forms-field">
