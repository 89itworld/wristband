<script>
	$.validator.addMethod("image_required", function(value, element) {
		return value != "";
	}, "Please select a image for banner.");

	$(document).ready(function() {
		$("#BannerBandheadAddForm").validate();
	}); 
</script>
		        ...
		        <div class="col-sm-8 col-lg-10 col-md-9 col-xs-12">
		            ...
		            <div class="col-md-12 rr ">
		                <div class="ps">
		                    ...
		                    <ul class="list-inline pull-right">
                            		<li><?php echo $this -> Html -> link('<i class="fa fa-list"></i> List Banners', array('controller' => 'Banners', 'action' => 'index', 'bandhead' => true), array('escape' => false)); ?></li>
                            	</ul>	
		                    </h3>
		                </div>
		            </div>
		            <div class="col-md-12">
		                <div class="content-forms content-box">
		                    <?php
                            echo $this -> Form -> create('Banner', array('type' => 'file', 'url' => array('controller' => 'Banners', 'action' => 'add', 'bandhead' => true)));
	                        ?>
